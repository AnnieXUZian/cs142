      ...
      <HashRouter>
        <div>
          <Grid container spacing={2}>
            <Grid item xs={12}>
            <TopBar message={this.state.message}/>
            </Grid>
            ...
            <Grid item sm={9}>
              <Paper className="cs142-main-grid-item">
                <Switch>
                  ...
                  <Route
                    path="/users/:userId"
                    render={(props) => <UserDetail sendDataToParent={this.handleChildData} {...props} />}
                  />
                  <Route
                    path="/photos/:userId"
                    render={(props) => <UserPhotos sendDataToParent={this.handleChildData} {...props} />}
                  />
